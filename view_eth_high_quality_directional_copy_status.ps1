...
Write-Host "=== ETH high-quality directional copy process ==="
Get-CimInstance Win32_Process |
  Where-Object { $_.CommandLine -like "*eth_high_quality_directional_copy_sim.py*" } |
  Select-Object ProcessId,CommandLine |
  Format-Table -AutoSize

Write-Host "`n=== Recent console ==="
$console = Join-Path $workdir "eth_high_quality_directional_copy_console.log"
...
$errors = Join-Path $workdir "eth_high_quality_directional_copy_error.log"
...
$trades = Join-Path $workdir "eth_high_quality_directional_copy_sim.csv"
