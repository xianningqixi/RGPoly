...
Write-Host "=== BTC directional live shadow process ==="
Get-CimInstance Win32_Process |
  Where-Object { $_.CommandLine -like "*btc_directional_live_shadow_sim.py*" } |
  Select-Object ProcessId,CommandLine |
  Format-Table -AutoSize

Write-Host "`n=== Recent console ==="
$console = Join-Path $workdir "btc_directional_live_shadow_console.log"
...
$errors = Join-Path $workdir "btc_directional_live_shadow_error.log"
...
$trades = Join-Path $workdir "btc_directional_live_shadow_sim.csv"
